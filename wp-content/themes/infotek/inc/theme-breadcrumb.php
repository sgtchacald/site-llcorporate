...
class Infotek_Breadcrumb {
	/**
	 * Array of bread Infotek_Breadcrumb
	 *
	 * @var array
	 */
	...
	public function __construct( array $options = [] ) {
		...
		$this->defaults['home'] = esc_html__('Home','infotek');
		$this->defaults['blog'] = esc_html__('Blog','infotek');
	...
	public function theBreadcrumbs() {
		...
		foreach ( $breadcrumbs as $crumb ) {
			...
			if ( $crumb['url'] ) {
                ...
                $html .= sprintf( '<span>%s</span>', wp_kses($crumb['title'],infotek()->kses_allowed_html('all')) );
			}
		...
		echo wp_kses($html,infotek()->kses_allowed_html('all'));
	}
	...
	public function getBreadcrumbs() {
		...
		$breadcrumbs = apply_filters( 'infotek_get_breadcrumbs', $breadcrumbs );
 ...
 * Template Functions.
 */
if ( ! function_exists( 'infotek_breadcrumb' ) ) {
	/**
	 ...
	 * @package infotek
	 */
	function infotek_breadcrumb( $options = [] ) {
		$Crumbs = new Infotek_Breadcrumb( $options );
		$Crumbs->theBreadcrumbs();
	}
}

if ( ! function_exists( 'infotek_get_breadcrumbs' ) ) {
	/**
	 ...
	 * @return array
	 */
	function infotek_get_breadcrumbs( $options = [] ) {
		$Crumbs = new Infotek_Breadcrumb( $options );
 ...
 * Utility functions
 */
if ( ! function_exists( 'infotek_breadcrumb_array_insert' ) ) {
	/**
	 ...
	 * @return array
	 */
	function infotek_breadcrumb_array_insert( array $array, $element, int $position ) {

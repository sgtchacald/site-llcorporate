...
$typography_css = $infotek->generate_css_code([
    'font-family' => $body_font['family'] . ', sans-serif'
], 'html,body');

$typography_css .= $infotek->generate_css_code([
    'font-size' => $infotek->sanitize_px($body_font['size']),
...
$heading_font_css = $infotek->generate_css_code([
...
$body_font_css = $infotek->generate_css_code([
...
$root_color_css = $infotek->generate_css_code([
...
$preloader_css = $infotek->generate_css_code([
...
$breadcrumb_css = $infotek->generate_css_code([
...
$footer_padding_top = !empty($footer_top_spacing) ? $infotek->sanitize_px($footer_top_spacing) : '';
$footer_padding_bottom = !empty($footer_bottom_spacing) ? $infotek->sanitize_px($footer_bottom_spacing) : '';


$footer_css = $infotek->generate_css_code([
...
$footer_two_padding_top = !empty($footer_two_top_spacing) ? $infotek->sanitize_px($footer_two_top_spacing) : '';
$footer_two_padding_bottom = !empty($footer_two_bottom_spacing) ? $infotek->sanitize_px($footer_two_bottom_spacing) : '';

$footer_css_two = $infotek->generate_css_code([
...
$footer_three_padding_top = !empty($footer_three_top_spacing) ? $infotek->sanitize_px($footer_three_top_spacing) : '';
$footer_three_padding_bottom = !empty($footer_three_bottom_spacing) ? $infotek->sanitize_px($footer_three_bottom_spacing) : '';


$footer_three_css = $infotek->generate_css_code([
...
$copyright_padding_top = !empty($copyright_area_top_spacing) ? $infotek->sanitize_px($copyright_area_top_spacing) : '';
$copyright_padding_bottom = !empty($copyright_area_bottom_spacing) ? $infotek->sanitize_px($copyright_area_bottom_spacing) : '';

$copyright_css = $infotek->generate_css_code([
...
$copyright_two_padding_top = !empty($copyright_two_area_top_spacing) ? $infotek->sanitize_px($copyright_two_area_top_spacing) : '';
$copyright_two_padding_bottom = !empty($copyright_two_area_bottom_spacing) ? $infotek->sanitize_px($copyright_two_area_bottom_spacing) : '';

$copyright_css_two = $infotek->generate_css_code([
...
$copyright_three_padding_top = !empty($copyright_three_area_top_spacing) ? $infotek->sanitize_px($copyright_three_area_top_spacing) : '';
$copyright_three_padding_bottom = !empty($copyright_three_area_bottom_spacing) ? $infotek->sanitize_px($copyright_three_area_bottom_spacing) : '';

$copyright_css_three = $infotek->generate_css_code([
...
$header_one_css = $infotek->generate_css_code([
...
$header_two_css = $infotek->generate_css_code([
...
$sidebar_css = $infotek->generate_css_code([
...
$footer_two_css .= $infotek->generate_css_code([
...
$copyright_two_css = $infotek->generate_css_code([
...
$copyright_three_css = $infotek->generate_css_code([
...
$err_padding_top = !empty($err_404_spacing_top) ? $infotek->sanitize_px($err_404_spacing_top) : '';
$err_padding_bottom = !empty($err_404_spacing_bottom) ? $infotek->sanitize_px($err_404_spacing_bottom) : '';

$error_css = $infotek->generate_css_code([
...
$blog_padding_top = !empty($blog_page_spacing_top) ? $infotek->sanitize_px($blog_page_spacing_top) : '';
$blog_padding_bottom = !empty($blog_page_spacing_bottom) ? $infotek->sanitize_px($blog_page_spacing_bottom) : '';

$blog_css = $infotek->generate_css_code([
...
$blog_single_padding_top = !empty($blog_single_page_spacing_top) ? $infotek->sanitize_px($blog_single_page_spacing_top) : '';
$blog_single_padding_bottom = !empty($blog_single_page_spacing_bottom) ? $infotek->sanitize_px($blog_single_page_spacing_bottom) : '';

$blog_single_css = $infotek->generate_css_code([
...
$archive_single_padding_top = !empty($archive_page_spacing_top) ? $infotek->sanitize_px($archive_page_spacing_top) : '';
$archive_single_padding_bottom = !empty($archive_page_spacing_bottom) ? $infotek->sanitize_px($archive_page_spacing_bottom) : '';

$archive_page_css = $infotek->generate_css_code([
...
$search_single_padding_top = !empty($search_page_spacing_top) ? $infotek->sanitize_px($search_page_spacing_top) : '';
$search_single_padding_bottom = !empty($search_page_spacing_bottom) ? $infotek->sanitize_px($search_page_spacing_bottom) : '';

$search_page_css = $infotek->generate_css_code([
...
$search_single_padding_top = !empty($service_single_page_spacing_top) ? $infotek->sanitize_px($service_single_page_spacing_top) : '';
$search_single_padding_bottom = !empty($service_single_page_spacing_bottom) ? $infotek->sanitize_px($service_single_page_spacing_bottom) : '';

$service_single_page_css = $infotek->generate_css_code([

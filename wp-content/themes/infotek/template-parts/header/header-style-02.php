...
<?php 
    $header_three_search_enabled = cs_get_option('header_three_search_enabled');          
...
<header>
    ...
    <div id="header-sticky" class="header-3">
        <div class="plane-shape">
            <img src="<?php echo esc_url($header_three_left_shape['url']); ?>" alt="shape-img">
        </div>
        <div class="container">
            <div class="mega-menu-wrapper">
                <div class="header-main">
                    ...
                    <div class="header-right d-flex justify-content-end align-items-center">
                        ...
                        <?php 
                        if( $header_three_search_enabled ): ?>
                        ...
                        if( $header_three_right_btn_enabled ): ?>
                            <a href="<?php echo esc_url($header_three_right_btn_url); ?>" class="theme-btn bg-white">
                                <span>

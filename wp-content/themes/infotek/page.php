...
$page_layout_meta = Infotek_Group_Fields_Value::page_layout('infotek');
$page_container_meta = Infotek_Group_Fields_Value::page_container('infotek','container_options');
...
if ('blank' == $page_layout_meta['layout']):
	...
	?>
    <div id="primary" class="content-area infotek-page-content-area padding-120 page-content-wrap-<?php the_ID(); ?> <?php echo esc_attr($full_width_class);?>">

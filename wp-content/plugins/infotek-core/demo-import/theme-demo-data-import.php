...
function import_files()
{
    return [
        [
            'import_file_name'           => 'Infotek',
            'categories'                   => 'infotek-core',
            'local_import_file'            => trailingslashit(INFOTEK_CORE_ROOT_PATH) . 'demo-import/demo-data/content.xml',
            'local_import_customizer_file'     => trailingslashit(INFOTEK_CORE_ROOT_PATH) . 'demo-import/demo-data/customize.dat',
            'local_import_widget_file'     => trailingslashit(INFOTEK_CORE_ROOT_PATH) . 'demo-import/demo-data/widgets.wie',
            'local_import_json' => array(
                array(
                    'file_path'     => trailingslashit(INFOTEK_CORE_ROOT_PATH) . 'demo-import/demo-data/theme-settings.json',
                    'option_name'   => 'infotek_theme_options',
                ),
            ),
            ...
            'preview_url'   => 'https://gramentheme.com/wp/infotek'
        ],
    ];
}

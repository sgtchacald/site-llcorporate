...
class Infotek_Category_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct(
            'infotek_category',
            esc_html__( 'Infotek:  Category', 'infotek-core' ),
            array( 'description' => esc_html__( 'Display  categories', 'infotek-core' ) )
        );
    }
    ...
    public function widget( $args, $instance ) {
        ...
        if ( ! empty( $all_terms ) ):?>
            ...
            esc_html__( ' Oops, there are no category.', 'infotek-core' )
            ?>
        <?php endif; ?>
        </ul>
        <?php
    ...
    public function form( $instance ) {
        ...
        if (!empty($instance) && $instance['title']) {
            ...
            $title = esc_html__('Category', 'infotek-core');
        ...
        $taxonomy = array(
            'category' => esc_html__('Blog Category', 'infotek-core'),
            'packages-cat' => esc_html__('Packages Category', 'infotek-core'),
            'project-cat' => esc_html__('project Category', 'infotek-core'),
            'course-category' => esc_html__('Courses Category', 'infotek-core'),
            'service-cat' => esc_html__('Service Category', 'infotek-core')
        );
        $order_arr   = array(
        ...
        ?>
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('taxonomy')) ?>"><?php esc_html_e('Taxonomy', 'infotek-core'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('number')) ?>"><?php esc_html_e('Number', 'infotek-core'); ?></label>
...
if ( ! function_exists( 'Infotek_Category_Widget' ) ) {
    function Infotek_Category_Widget() {
        register_widget( 'Infotek_Category_Widget' );
    }

    add_action( 'widgets_init', 'Infotek_Category_Widget' );
}
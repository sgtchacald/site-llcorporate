...
class Infotek_Recent_Post_Widget extends WP_Widget

{
    public function __construct()
    {
        parent::__construct(
            'infotek_popular_posts',
            esc_html__('Infotek: Recent Posts with Thumbnails', 'infotek-core'),
...
if (!function_exists('Infotek_Recent_Post_Widget')) {

    function Infotek_Recent_Post_Widget()

    {
        register_widget('Infotek_Recent_Post_Widget');
    }

    add_action('widgets_init', 'Infotek_Recent_Post_Widget');

...
class About_Content extends Widget_Base {
	...
	public function get_name() {
		return 'infotek-about-content-widget';
	}
	...
	public function get_title() {
		return esc_html__( 'About Content', 'infotek-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'about_content',
			[
				'label' => esc_html__( 'About Content', 'infotek-core' ),
			]
		);		
		...
		<div class="about-content">
			...
			<div class="icon-area wow fadeInUp" data-wow-delay=".7s">
				...
				<div class="icon-items">
					...
					<div class="content">
						<h2>
							<span class="count"><?php echo $settings['title1'];?> </span>+
						</h2>
...
Plugin::instance()->widgets_manager->register_widget_type(new About_Content());
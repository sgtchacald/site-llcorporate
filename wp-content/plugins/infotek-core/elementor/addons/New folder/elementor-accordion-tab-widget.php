...
namespace Elementor;
class Infotek_Accordion_Tab_One extends Widget_Base
{
    ...
    {
        return 'infotek-accordion-tab-one-widget';
    }
    ...
    {
        return esc_html__('Accordion Tab 01', 'infotek-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section(
            'settings_section',
            [
                'label' => esc_html__('Tab 1 Settings', 'infotek-core'),
        ...
        $this->start_controls_section(
            'settings_section_2',
            [
                'label' => esc_html__('Tab 2 Settings', 'infotek-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $repeater = new \Elementor\Repeater();
        ...
        $this->add_control('accordion_items2', [
            'label' => esc_html__('Accordion Item Two', 'infotek-core'),
            'type' => Controls_Manager::REPEATER,
            'fields' => $repeater->get_controls(),
        ]);
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            'settings_section_3',
            [
                'label' => esc_html__('Tab 3 Settings', 'infotek-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $repeater = new \Elementor\Repeater();
        ...
        $this->add_control('accordion_items3', [
            'label' => esc_html__('Accordion Item Three', 'infotek-core'),
            'type' => Controls_Manager::REPEATER,
            'fields' => $repeater->get_controls(),
        ]);
        $this->end_controls_section();
        ...
        $this->start_controls_section(
            'settings_section_4',
            [
                'label' => esc_html__('Tab 4 Settings', 'infotek-core'),
                'tab' => Controls_Manager::TAB_CONTENT,
            ]
        );
        $repeater = new \Elementor\Repeater();
        ...
        $this->add_control('accordion_items4', [
            'label' => esc_html__('Accordion Item Four', 'infotek-core'),
            'type' => Controls_Manager::REPEATER,
            'fields' => $repeater->get_controls(),
        ]);
        $this->end_controls_section();
        ...
        $this->add_control('icon_color', [
            ...
            'selectors' => [
                "{{WRAPPER}} .single-accordion-inner.style-2 .accordion-item .accordion-button.collapsed:after" => "color: {{VALUE}}",
            ]
        ]);
    ...
    protected function render()
    {
        ...
        $accordion_items2 = $settings['accordion_items2'];
        $accordion_items3 = $settings['accordion_items3'];
        $accordion_items4 = $settings['accordion_items4'];
        $random_number = rand(999, 999999);
        ?>

        <div class="accordion-tab-inner">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-6">
                    <div class="accordion single-accordion-inner style-2" id="accordionExample22">
                        <?php $i = 10; foreach ($accordion_items2 as $item2): ?>
                        <?php
                            $j = '';
                            $k = '';
                            if($i == 10) {
                        ...
                        ?>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="heading<?php echo $i; ?>">
                                    <button class="accordion-button <?php echo $l; ?>" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>">
                                        <?php echo esc_html($item2['title']); ?>
                                    </button>
                                </h2>
                                <div id="collapse<?php echo $i; ?>" class="accordion-collapse collapse <?php echo $j; ?>" aria-labelledby="heading<?php echo $i; ?>" data-bs-parent="#accordionExample22">
                                    <div class="accordion-body">
                                        <?php echo esc_html($item2['content_title']); ?>
                                    </div>
                                </div>
                            </div>
                        <?php $i++; endforeach; ?>
...
Plugin::instance()->widgets_manager->register_widget_type(new Infotek_Accordion_Tab_One());
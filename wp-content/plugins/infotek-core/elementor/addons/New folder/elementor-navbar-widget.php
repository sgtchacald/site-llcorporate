...
namespace Elementor;
class Infotek_Navbar_Widget extends Widget_Base
{
    ...
    {
        return esc_html__('Navbar', 'infotek-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'logo_image', [
                'label' => esc_html__('Logo Image', 'agiletech-core'),
                'type' => Controls_Manager::MEDIA,
                'default' => [
                    'url' => Utils::get_placeholder_image_src(),
                ],
                'show_label' => false,
                'description' => esc_html__('Upload Logo image', 'agiletech-core'),
            ]
        );
        ...
        $this->add_control('btn_color', [
            'label' => esc_html__('Btn Color', 'agiletech-core'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .nav-right-part .right-btn-text" => "color: {{VALUE}}",
            ]
        ]);
        $this->add_control('nav_text_color', [
            'label' => esc_html__('Nav Text Color', 'agiletech-core'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .navbar.navbar-area.navbar-expand-lg.navigation-style-01.navbar-default .custom-container .navbar-collapse .navbar-nav > li a" => "color: {{VALUE}}",
                "{{WRAPPER}} .navbar.navbar-area.navbar-expand-lg.navigation-style-01.navbar-default .custom-container .navbar-collapse .navbar-nav li.menu-item-has-children:before" => "background: {{VALUE}}",
                "{{WRAPPER}} .navbar.navbar-area.navbar-expand-lg.navigation-style-01.navbar-default .custom-container .navbar-collapse .navbar-nav li.menu-item-has-children:after" => "background: {{VALUE}}",
            ]
        ]);
        $this->add_control('nav_text_color_submenu', [
            'label' => esc_html__('Nav Text Color', 'agiletech-core'),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
                "{{WRAPPER}} .navbar.navbar-area.navbar-expand-lg.navigation-style-01.navbar-default .custom-container .navbar-collapse .navbar-nav li.menu-item-has-children .sub-menu li a" => "color: {{VALUE}}",
            ]
        ]);
        $this->end_controls_section();
    }
    ...
    protected function render()
    {
        ...
        <nav class="navbar navbar-area navbar-expand-lg navigation-style-01 navbar-area-2 navbar-default">
...
Plugin::instance()->widgets_manager->register_widget_type(new Infotek_Navbar_Widget());
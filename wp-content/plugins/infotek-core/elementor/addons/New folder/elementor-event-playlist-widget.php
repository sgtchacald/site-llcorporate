...
namespace Elementor;
class Infotek_Event_Playlist_Widget extends Widget_Base
{
    ...
    {
        return 'infotek-event-playlist-widget';
    }
    ...
    {
        return esc_html__('Event Playlist', 'infotek-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'video_url',
            [
                'label' => esc_html__('video url', 'infotek-core'),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__('View all', 'infotek-core'),
            ]
        );
    ...
    protected function render()
    {
        ...
        <div class="audio-chart-list-area border-radius-0">
        	<div class="row">
        		<div class="col-lg-6">
        			<ul class="banner-audio-list event-playlist-audio-list">
		                <?php
        		...
        		<div class="col-lg-6 ps-lg-0">
        			<div class="video-thumb-event-play-list">
        				<video class="vdo" src="<?php echo $settings['video_url'] ?>" loop="1" preload="auto" muted="" autoplay="1"></video>
        			</div>
        		</div>
        	</div>
...
Plugin::instance()->widgets_manager->register_widget_type(new Infotek_Event_Playlist_Widget());
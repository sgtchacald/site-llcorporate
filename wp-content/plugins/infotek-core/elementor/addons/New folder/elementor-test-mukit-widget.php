...
namespace Elementor;
class Infotek_Test_Mukit extends Widget_Base
{
    ...
    {
        return 'infotek-test-mukit-widget';
    }
    ...
    {
        return esc_html__('Test Mukit', 'infotek-core');
    }
...
Plugin::instance()->widgets_manager->register_widget_type(new Infotek_Test_Mukit());